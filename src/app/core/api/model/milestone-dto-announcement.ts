...
export interface MilestoneDtoAnnouncement { 
    sentAt: string;
    sentBy: string;
    announcementType: MilestoneDtoAnnouncement.AnnouncementTypeEnum;
    audience: MilestoneDtoAnnouncement.AudienceEnum;
    recipientCount: number;
    reachableCount: number;
}
export namespace MilestoneDtoAnnouncement {
